...
create or replace database BENAS_DOOR;

use database BENAS_DOOR;
...
DELETE FROM BENAS_DOOR.PUBLIC.ASSET WHERE ID = '${ASSET_JSON.assetId}'`});
    var insertAsset = snowflake.execute({sqlText: `
INSERT INTO BENAS_DOOR.PUBLIC.ASSET (ID, REFERENCE_COPY_KEY, FILE_FORMAT, FILE_TYPE, SCHEMA_VERSION, ORIGINAL_FILENAME, SIZE, SOURCE, TAGS)
